    ...
    return (
        <div className="relative bg-gray-900 container mx-auto mt-4 md:rounded-l-full border overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
                ...
                <p className="text-yellow-300 text-xl mb-8">Discover endless joy with our captivating collection of car toys. Explore a world of miniature vehicles, tracks, and accessories that fuel imagination and ignite thrilling playtime adventures</p>
