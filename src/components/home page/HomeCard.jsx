        ...
        <div className='mt-10'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-10 md:mx-20 mx-5 md:px-28  '>
                <div className='bg-cyan-700 h-48 border flex-flex-col items-start justify-center p-4'>
                    <div className='p-4 bg-slate-200 w-1/3 flex justify-center font-extrabold text-cyan-700 text-3xl'><BsFillCarFrontFill></BsFillCarFrontFill></div>
                ...
                <div className='bg-cyan-700 h-48 border flex-flex-col items-start justify-center p-4'>
                    <div className='p-4 bg-slate-200 w-1/3 flex justify-center font-extrabold text-cyan-700 text-3xl'><SiMaterialdesignicons></SiMaterialdesignicons></div>
                ...
                <div className='bg-cyan-700 h-48 border flex-flex-col items-start justify-center p-4'>
                    <div className='p-4 bg-slate-200 w-1/3 flex justify-center font-extrabold text-cyan-700 text-3xl'><BsShopWindow></BsShopWindow></div>
                ...
                <div className='bg-cyan-700 h-48 border flex-flex-col items-start justify-center p-4 '>
                    <div className='p-4 bg-slate-200 w-1/3 flex justify-center font-extrabold text-cyan-700 text-3xl'><GrCart></GrCart></div>
